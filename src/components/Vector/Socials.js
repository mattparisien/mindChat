function Google() {
	return (
		<svg width="25px" height="25px" className="SocialIcon Google">
...
function Facebook() {
	return (
		<svg width="25px" height="25px" className="SocialIcon Facebook">
			<path
...
function Email() {
	return (
		<svg width="25px" height="25px" className="SocialIcon Email">
